<div class="container galleryPage">
    ...
    <div class="row" id="photo_swipe">
        <?php if (!empty($this->data["gallery"])): ?>
            <?php foreach ($this->data["gallery"]["image_list"] as $item): ?>
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        <div class="bgChange">
                            <a rel="<?= $item["gallery_name"] ?>" href="<?= base_url("uploads/" . $item["file_name"]) ?>" class="swipebox">
                                <div class="bgImg"><i class="fa fa-external-link" aria-hidden="true"></i></div>
                                <img class="img-responsive" src="<?= base_url("uploads/thumb_" . $item["file_name"]) ?>" alt="image">
                            </a>
                        </div>
                        <div class="caption">
                            <a href="#">
                                <p class="text-center"><?php echo isEnglishLang() ? $item["description_en"] : $item["description_th"] ?></p>
                            </a>
                        </div>
                    </div>
                </div>
