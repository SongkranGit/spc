if (!document.createElement("canvas").getContext) {
    (function () {
        ...
        M.drawText_ = function (AK, AI, AH, AN, AG) {
            ...
            AE.push('<g_vml_:skew on="t" matrix="', AL, '" ', ' offset="', AJ, '" origin="', i, ' 0" />', '<g_vml_:path textpathok="true" />', '<g_vml_:textpath on="true" string="', AD(AK), '" style="v-text-align:', p, ";font-awesome:", AD(j), '" /></g_vml_:line>');
